...
<div class="d-flex flex-column bd-highlight mb-3 container py-4" style="margin-top:1%; padding-top : 3%;" >

<div class="p-1 mb-1" style="border:solid gray 2px; border-radius: 15px; background-color: #ebf8e6; ">
  <div class="row gx-2" style="padding-top : 3%;">
    ...
    <div class="col-1"></div>
    <div class="col-5">
        <img src='images/user.png' width='35%' alt=''>
    </div>
  </div>
  <br>
...
<div class="row align-items-md-stretch"  style="padding-top : 3%;">
