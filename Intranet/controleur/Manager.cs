...
namespace Intranet
{
    public class Manager
    {
        ...
        private int id_planning, id_manager_sup, id_local;
        ...
        public Manager()
        {
            ...
            this.id_planning = this.id_manager_sup = this.id_local = 0;
        }

        public Manager(string email, string mdp, string nom, string prenom,
        ...
        int id_planning, int id_manager_sup, int id_local)
        {
            this.email = email;
            this.mdp = mdp;
            this.nom = nom;
            ...
            this.id_manager_sup = id_manager_sup;
            this.id_local = id_local;
        }

        public Manager(int id_manager, string email, string mdp, string nom, string prenom,
        string tel, string rue, string numrue, string ville, string cp, string fonction, string salaire,
        string niveau_diplome, DateTime date_embauche, DateTime date_depart, string droits,
        int id_planning, int id_manager_sup, int id_local)
        {
        ...
        public int Id_manager_sup
        {
            get => id_manager_sup; set => id_manager_sup = value;
        }
