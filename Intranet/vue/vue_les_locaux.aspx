<div class="table-responsive w-100" style="height:40vh;border : 4px solid #9FC490;  border-radius: 10px;">
    ...
    foreach(locaux unLocal in lesLocals)
    {   
         ...
         chaine += "<td>";
         chaine += "<a href='Default.aspx?page=13&action=sup&id_local=" + unLocal.Id_local + "'><img src='images/sup.png' height='35' width='35'></br>";
         chaine += "<a href='Default.aspx?page=13&action=edit&id_local=" + unLocal.Id_local + "'><img src='images/edit.png' height='35' width='35'></a>";
         chaine += "</td>";
