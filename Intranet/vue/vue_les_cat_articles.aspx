<div class="table-responsive w-100" style="height:40vh;border : 4px solid #9FC490;  border-radius: 10px;">
    ...
    {   
         ...
         chaine += "<td>"+uneCategorie_article.Id_categorie_article+"</td>";
         chaine += "<td>"+uneCategorie_article.Libelle+"</td>";
         chaine += "<td>"+uneCategorie_article.Description+"</td>";


         chaine += "<td>";
         chaine += "<a href='Default.aspx?page=14&action=sup&id_categorie_article=" + uneCategorie_article.id_categorie_article + "'><img src='images/sup.png' height='35' width='35'></br>";
         chaine += "<a href='Default.aspx?page=14&action=edit&id_categorie_article=" + uneCategorie_article.id_categorie_article + "'><img src='images/edit.png' height='35' width='35'></a>";
         chaine += "</td>";
